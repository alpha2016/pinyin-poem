                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                        <span class="fa-stack fa-2x pull-left m-r-sm">
                            ...
                            <span class="easypiechart pos-abt" data-percent="100"
                                    ...
                                    data-scale-Color="false" data-size="50" data-line-cap='butt'
                                    data-animate="3000" data-target="#firers"
                                    data-update="5000">
                            </span>
                        </span>
                        <a class="clear" href="#">
                        ...
                        <div class="bg-light dk wrapper">
                            ...
                            <div class="text-center m-b-n m-t-sm">
                                <div class="sparkline" data-type="line" data-height="65"
                                     ...
                                     data-resize="true"
                                     values="280,320,220,385,450,320,345,250,250,250,400,380">
                                </div>
                                <div class="sparkline inline" data-type="bar" data-height="45"
                                     data-bar-width="6" data-bar-spacing="6"
                                     data-bar-color="#65bd77">10,9,11,10,11,10,12,10,9,10,11,9,8
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                    ...
                    <ul class="list-group gutter list-group-lg list-group-sp sortable">
                        <li class="list-group-item box-shadow">
                            ...
                            <span class="pull-left media-xs">
                                ...
                                <a href="#todo-1" data-toggle="class:text-lt text-success"
                                        class="active">
                ...
                <div class="col-md-4">
                    <section class="panel b-light">
                        ...
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item text-ellipsis">
                                <span class="badge bg-success">9:30</span> Have a kick off meeting
                                with .inc company
                            </a>
                            <a href="#" class="list-group-item text-ellipsis">
                ...
                <section class="comment-list block">
                    <article id="comment-id-1" class="comment-item">
                        ...
                        <section class="comment-body m-b-lg">
                            <header>
                                <a href="#"><strong>John smith</strong></a> shared a
                                <a href="#" class="text-info">video</a>
                                to you <span class="text-muted text-xs"> 24 minutes ago
                                </span>
                            </header>
                            <div>
                    ...
                    <article id="comment-id-2" class="comment-reply">
                        <article class="comment-item">
                            <a class="pull-left thumb-sm">
                                <img src="{{ asset('assets/images/avatar_default.jpg') }}" class="img-circle">
                            </a>
                            <section class="comment-body m-b-lg">
                                <header>
                                    <a href="#">
                    ...
                    <article id="comment-id-2" class="comment-item">
                        ...
                        <section class="comment-body m-b-lg">
                            <header>
                                ...
                                <span class="text-muted text-xs"> 1 hour ago </span></header>
